		...
		*m_PC += 2;
		...
		if (opcode == 0b00)
		{
			...
			case 0:
				...
				ss << "\tSQ\t" << getAPIName(rs1) << ", " << getAPIName(rs2) << ", " << std::hex << "0x" << (int)S_imm << "\n";
				break;
			case 1:
				ss << "\tSW\t" << getAPIName(rs1) << ", " << getAPIName(rs2) << ", " << std::hex << "0x" << (int)S_imm << "\n";
				break;
			case 2:
				ss << "\tSD\t" << getAPIName(rs1) << ", " << getAPIName(rs2) << ", " << std::hex << "0x" << (int)S_imm << "\n";
				break;
			default:
